...
- `欠紜1000-300-20-30+300`：自動計算 950，記錄你欠紜 950
- `欠 紜 飲料 80`：記錄你欠紜飲料錢 80
- `紜 欠我 電影票 280`：記錄紜欠你電影票 280
- `紜欠我500`：記錄紜欠你 500
- `分帳 1280 我 紜 阿豪 小美`：你先付 1280，四人平均分帳
- `還紜300`：記錄你已還紜 300
- `紜還我200`：記錄紜已還你 200
- `/欠`：列出雙方目前誰欠誰多少
- `/欠 紜`：只查紜的帳務明細
...
| 目的 | 指令 | 範例 |
| --- | --- | --- |
| 記錄你欠對方 | `欠對象金額或算式` | `欠紜1000-300-20-30+300` |
| 記錄你欠對方並加備註 | `欠 對象 備註 金額` | `欠 紜 飲料 80` |
| 記錄對方欠你 | `對象欠我金額或算式` | `紜欠我500` |
| 記錄對方欠你並加備註 | `對象 欠我 備註 金額` | `紜 欠我 電影票 280` |
| 記錄你還對方 | `還對象金額` | `還紜300` |
| 記錄你還對方並加備註 | `還 對象 備註 金額` | `還 紜 飲料 80` |
| 記錄對方還你 | `對象還我金額` | `紜還我200` |
| 分帳 | `分帳 總金額 我 對象1 對象2` | `分帳 1280 我 紜 阿豪 小美` |
| 查欠款總表 | `/欠` | `/欠` |
| 查單一對象 | `/欠 對象` | `/欠 紜` |
| 查欠款明細 | `/欠明細` | `/欠明細` |
| 查單一對象明細 | `/欠明細 對象` | `/欠明細 紜` |
| 刪除錯帳 | `/刪欠 編號` | `/刪欠 D3` |
| 結清某人 | `/結清 對象` | `/結清 紜` |
